...
extension Token.Space {
    ...
    public static var windowRadius: CGFloat { Appearance.value(.windowRadius) }
    ...
    public static var windowBorderWidth: CGFloat { Appearance.value(.windowBorderWidth) }
    ...
    public static var paneRadius: CGFloat { Appearance.value(.paneRadius) }
    ...
    public static var headerBlurRadius: CGFloat { Appearance.value(.headerBlurRadius) }
    ...
    public static var headerTintOpacity: CGFloat { Appearance.value(.headerTintOpacity) }
    ...
    public static var paneShadowRadius: CGFloat { Appearance.value(.paneShadowRadius) }
    public static var paneShadowOpacity: Float { Float(Appearance.value(.paneShadowOpacity)) }
}
