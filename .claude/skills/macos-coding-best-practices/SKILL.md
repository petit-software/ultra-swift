...
1. **Swift Language**: `swift-language.md`
...
3. **Data Persistence**: `data-persistence.md`
   - SwiftData best practices
   - Core Data (when needed)
   - Migration strategies

4. **Code Organization**: `code-organization.md`
   - Modular architecture
   - Feature vs layer organization
   - Package structure

5. **Modern Concurrency**: `modern-concurrency.md`
